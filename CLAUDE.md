...
├── module_2/
│   └── lessons/                ← lesson_18_functions_first_class/ … lesson_22_practicum_recursion/ (rest of М2 pending)
│
├── tools/
