...
├── module_2/
│   └── lessons/                ← lesson_18_functions_first_class/ … lesson_21_encapsulation_scope/ (rest of М2 pending)
│
├── tools/
