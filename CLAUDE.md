...
├── module_2/
│   └── lessons/                ← lesson_18_functions_first_class/, lesson_19_classes_namespace/ (rest of М2 pending)
│
├── tools/
