...
├── module_2/
│   └── lessons/                ← lesson_18_functions_first_class/ … lesson_20_inheritance_polymorphism/ (rest of М2 pending)
│
├── tools/
