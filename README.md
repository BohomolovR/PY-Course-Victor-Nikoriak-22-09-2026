...
Повна теорія, довідники та інструкції — у [книзі документації](docs/index.md) (MkDocs; після публікації — на GitHub Pages за адресою з `mkdocs.yml`).
...
1. [Встанови Git](docs/00_getting_started/git_setup.md)
2. [Створи SSH-ключ і Fork репозиторію](docs/00_getting_started/github/fork_and_clone.md)
3. [Налаштуй Python-середовище](docs/00_getting_started/environment_setup.md)
4. Відкрий перший урок у `module_1/lessons/`
