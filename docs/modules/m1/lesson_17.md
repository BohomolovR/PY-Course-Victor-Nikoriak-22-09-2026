...
А тепер згадай весну 2020-го. Карантин: зали кафе зачинені, гостей немає. Таксі стоять: пасажирів теж немає. І водночас — **бум доставки**: люди сидять удома й замовляють їжу, а бізнес, який швидко переналаштувався, вижив. Кафе «Смачно» і диспетчерська таксі домовляються: кафе готує, водії таксі розвозять. За кілька тижнів доставка стає головним джерелом виторгу для обох.

Але облік у них різний: у кафе — рядки каси, у таксі — журнал поїздок. Потрібна **одна система**, яка знає і про чеки, і про доставки. Це фінальний проєкт модуля: ти збереш його сам, за день чи два, і в ньому знадобиться майже все, що було в модулі.
...
Доставка на карантині працює так. Каса кафе, як і раніше, дає замовлення рядками. Адміністратор додає до замовлення доставку: район, вартість, водія. Власниця хоче спільний звіт: скільки замовлень, скільки з них доставлено, виторг кафе й таксі, найкращий день, популярні райони — куди варто відправити більше водіїв. А служба підтримки — знайти пару доставок під ваучер.
